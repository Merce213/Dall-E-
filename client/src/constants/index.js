export const surpriseMePrompts = [
    ...
    "A city made entirely out of ice cream",
    "A flying elephant playing a harp",
    "A castle on the moon",
    "A dinosaur wearing a tutu and top hat",
    "A robot made out of flowers",
    "A mermaid riding a seahorse",
    "A kangaroo playing the guitar",
    "A city in the clouds",
    "A dragon playing basketball",
    "A giant snail with a hat and a cane",
    "A school of fish driving a car",
    "A giraffe playing the piano",
    "A tree house made out of candy",
    "A spaceship shaped like a penguin",
    "A caterpillar riding a bicycle",
    "A person made of clouds",
    "A lighthouse in the shape of a starfish",
    "A robot elephant playing the drums",
    "A jellyfish with a crown and sceptre",
    "A castle on a giant lily pad",
];
